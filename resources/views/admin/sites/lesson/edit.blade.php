                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="uz">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[uz]" class="form-control">{{ $lesson->description['uz'] }}</textarea>
                        ...
                        <div class="tab-pane" id="ru">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description[ru]">{{ $lesson->description['ru'] }}</textarea>
                        ...
                        <div class="tab-pane" id="en">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[en]" class="form-control">{{ $lesson->description['en'] }}</textarea>
