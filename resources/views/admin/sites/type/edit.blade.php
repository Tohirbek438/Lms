...
@section('title', 'Site edit Section')
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('type_site.update', $lesson->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="tab-content">
                        <div class="tab-pane active" id="uz">
                            ...
                            <div class="form-group">
                                <label>Soni</label>
                                <input type="number" class="form-control" name="count" value="{{ $lesson->count }}">
                                @error('count')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
