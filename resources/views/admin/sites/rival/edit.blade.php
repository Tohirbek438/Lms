...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('rival.update', $mediaPortal->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="tab-content">
                        <div class="tab-pane active" id="uz">
                            ...
                            <div class="form-group">
                                <label>Users</label>
                                <input type="number" class="form-control" name="users" value="{{ $mediaPortal->users }}">
                                @error('users')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="description[uz]" class="form-control" cols="3" rows="3">{{ $mediaPortal->description['uz'] }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="media_id"
                                    value="{{ App\Models\MediaPortal::first()->id }}">
                                @error('media_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="tab-pane" id="ru">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[ru]" class="form-control" cols="3" rows="3">{{ $mediaPortal->description['ru'] }}</textarea>
                        ...
                        <div class="tab-pane" id="en">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[en]" class="form-control" cols="3" rows="3">{{ $mediaPortal->description['en'] }}</textarea>
