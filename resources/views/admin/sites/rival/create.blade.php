...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('rival.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-content">
                        <div class="tab-pane active" id="uz">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[uz]" class="form-control" cols="3" rows="3"></textarea>
                        ...
                        <div class="tab-pane" id="ru">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[ru]" class="form-control" cols="3" rows="3"></textarea>
                        ...
                        <div class="tab-pane" id="en">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[en]" class="form-control" cols="3" rows="3"></textarea>
