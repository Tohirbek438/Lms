...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('protect.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="tab-content">
                        <div class="tab-pane active" id="uz">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="description[uz]" class="form-control">Place <em>some</em> <u>text</u> <strong>here</strong>
                                  </textarea>
                                @error('description.uz')
                                    <span class="text-danger">{{ $message }}salom</span>
                                @enderror
                            </div>
                        </div>
                        <div class="tab-pane" id="ru">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description[ru]" id="summernote1">Place &lt;em&gt;some&lt;/em&gt; &lt;u&gt;text&lt;/u&gt; &lt;strong&gt;here&lt;/strong&gt;
                                </textarea>
                        ...
                        <div class="tab-pane" id="en">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description[en]" id="summernote2" class="form-control">Place &lt;em&gt;some&lt;/em&gt; &lt;u&gt;text&lt;/u&gt; &lt;strong&gt;here&lt;/strong&gt;
                                </textarea>
