...
@section('title', 'Preference section')
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('prefer.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="activity">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc[uz]" class="form-control" id="" cols="3" rows="3">{{ $project->desc['uz'] }}</textarea>
                                @error('desc.uz')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="tab-pane" id="timeline">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc[ru]" class="form-control" id="" cols="3" rows="3">{{ $project->desc['ru'] }}</textarea>
                                @error('desc.ru')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="tab-pane" id="settings">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desc[en]" class="form-control" id="" cols="3" rows="3">{{ $project->desc['en'] }}</textarea>
                                @error('desc.en')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
